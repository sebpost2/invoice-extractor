...
const enDict = {
    ...
    dashboard: {
      ...
      othersLabel: "Others",
      otherCurrenciesLabel: "Also tracked, shown separately since currencies can't be summed:",
...
const esDict: Dict = {
    ...
    dashboard: {
      ...
      othersLabel: "Otros",
      otherCurrenciesLabel: "También registrado, mostrado por separado porque las monedas no se pueden sumar:",
